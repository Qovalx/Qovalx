 ...
 * Path in repository: /assets/js/khaled-widget.v6.js
 *
 * Framework free. Add one line before </body> in every page layout:
 *   <script defer src="/assets/js/khaled-widget.v6.js"></script>
 *
...
(function () {
  ...
  function injectStyles() {
    var css = [
      ...
      ".qx-panel{position:absolute;inset-block-end:60px;inset-inline-end:0;width:min(340px,calc(100vw - 32px));height:min(480px,calc(100vh - 140px));padding:0;display:flex;flex-direction:column;background:#FFF9F2;border:1px solid rgba(1,18,48,.12);border-top:2px solid #D7A347;border-radius:2px;box-shadow:0 24px 60px rgba(1,18,48,.22);overflow:hidden}",
