 ...
 * Path in repository: /assets/js/professionals-directory.v1.js
 *
 * Renders the directory into <div id="qx-directory"> on the professionals
 * directory page of each published locale.
 *
...
(function () {
  ...
  function actions(record) {
    ...
    if (record.slug) {
      ...
      profile.href = "/" + locale + "/professionals/" + record.slug + ".html";
