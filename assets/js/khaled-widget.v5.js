 ...
 * Path in repository: /assets/js/khaled-widget.v5.js
 *
 * Framework free. Add one line before </body> in every page layout:
 *   <script defer src="/assets/js/khaled-widget.v5.js"></script>
 *
...
(function () {
  ...
  function injectStyles() {
    var css = [
      ...
      ".qx-launcher{display:inline-flex;align-items:center;gap:10px;padding:10px 18px;border:1px solid #D7A347;border-radius:2px;background:#011230;color:#FFF9F2;font:inherit;font-size:12px;letter-spacing:.08em;text-transform:uppercase;cursor:pointer;transition:background .2s ease,color .2s ease}",
